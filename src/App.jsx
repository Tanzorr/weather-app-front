...
function App() {
  ...
  return (
      <div className="container">
        ...
        <WeatherAlerts error={error} loading={loading} serverMessage={serverMessage} />
        ...
        {weatherData?.list?.length ? (
            ...
            !loading && weatherData?.list.length === 0 && <div className="alert alert-danger">No data found!</div>
        )}
      </div>
  );
}
